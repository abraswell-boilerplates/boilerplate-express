// Change shape of each object to project's table columns
...
function makeArticlesArray() {
  ...
  // Change shape of maliciousArticle object to project's table columns
    // adjust sample data accordingly
